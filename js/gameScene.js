...
class GameScene extends Phaser.Scene {
  ...
  createAlien () {
    ...
    let alienXVelocity = Math.floor(Math.random()) ? 1 : + 1 // this will get a number between 1 and 50 
    alienXVelocity *= Math.round(Math.random()) ? 1 : -1 // this will add minus sign in 50% of cases
    const anAlien = this.physics.add.sprite(alienXVelocity, -100, 'alien')
  ...
  constructor() {
    super({ key: "gameScene" })/* global Phaser */
